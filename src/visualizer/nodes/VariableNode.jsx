  ...
  return (
    <div
      ...
      style={{
        ...
        textAlign: 'center', minWidth: '100px', boxShadow: '0 4px 6px rgba(0,0,0,0.2)',
      }}
    >
      <Handle type="target" position={Position.Left} style={{ background: '#555', width: '8px', height: '8px' }} />
      <div style={{ fontSize: '10px', fontWeight: 'bold', marginBottom: '5px', color: isBoth ? '#fff' : '#666' }}>
      ...
      <Handle type="source" position={Position.Right} style={{ background: isBoth ? '#f39c12' : valueColors[data.value], width: '8px', height: '8px' }} />
    </div>
  );
}